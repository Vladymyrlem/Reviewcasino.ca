...
/*Bonuses*/
function bonuses_custom_post_type() {
	$labels = array(
		'name'               => __( 'Bonuses' ),
		'singular_name'      => __( 'Bonuses' ),
		'menu_name'          => __( 'Bonuses' ),
		'parent_item_colon'  => __( 'Parent Resource' ),
		'all_items'          => __( 'All Bonuses' ),
		'view_item'          => __( 'view  Bonuses' ),
		'add_new_item'       => __( 'Add New Bonuses' ),
		'add_new'            => __( 'Add new' ),
		'edit_item'          => __( 'Редактировать Bonuses' ),
		'update_item'        => __( 'update Bonuses' ),
		'search_items'       => __( 'Search Bonuses' ),
		'not_found'          => __( 'Bonuses not found' ),
		'not_found_in_trash' => __( 'Not found in Trash' )
	);
	$args   = array(
		'label'               => __( 'bonuses' ),
		'description'         => __( 'bonuses' ),
		'labels'              => $labels,
		'supports'            => array(
			'title',
			'editor',
...
add_action( 'init', 'bonuses_custom_post_type', 0 );

add_action( 'init', 'bonuses_custom_taxonomy', 0 );

//create a custom taxonomy name it "type" for your posts
function bonuses_custom_taxonomy() {
	$labels = array(
		'name'              => _x( 'Bonuses Categories', 'taxonomy general name' ),
		'singular_name'     => _x( 'Bonuses Categories', 'taxonomy singular name' ),
		'search_items'      => __( 'Search Types' ),
		'all_items'         => __( 'All Types' ),
		'parent_item'       => __( 'Parent Type' ),
		'parent_item_colon' => __( 'Parent Type:' ),
		...
		'add_new_item'      => __( 'Add New Type' ),
		'new_item_name'     => __( 'New Type Name' ),
		'menu_name'         => __( 'Bonuses Categories' ),
	);

	register_taxonomy( 'bonuses_cat', array( 'bonuses' ), array(
		'hierarchical'      => true,
		'labels'            => $labels,
		'show_ui'           => true,
		'show_admin_column' => true,
		'query_var'         => true,
		'rewrite'           => array( 'slug' => 'bonuses_cat' ),
	) );
}
