                        ...
                        <div class="hide-modal-group">
							...
							<?php if ( $free_link ) : ?>
                                <a class="free-game-link" href="<?php echo esc_url( $free_link['url'] ); ?>"
                                   target="<?php echo esc_attr( $free_link['target'] ); ?>"><?php echo esc_html( $free_link['title'] ); ?></a>
							<?php endif; ?>
