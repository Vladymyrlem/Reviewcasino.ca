<section class="top-casinos left-content">
    <div class="mycontainer">
        ...
        <div class="top-casinos-grid">
			...
			<?php $top_reviews = get_sub_field( 'top_reviews' ); ?>
			<?php if ( $top_reviews ) : ?>
				<?php foreach ( $top_reviews as $top_post ) : ?>
                    ...
                    <div class="top-casino-item" id="top-casino-<?php echo $i ++; ?>">
						...
						<?php if ( have_rows( 'real_money_group', $top_post->ID ) ) : ?>
							<?php while ( have_rows( 'real_money_group', $top_post->ID ) ) : the_row(); ?>
