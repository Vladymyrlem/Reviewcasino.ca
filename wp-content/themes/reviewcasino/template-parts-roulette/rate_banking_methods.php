<section class="dark-decor-section rate-banking-methods left-content">
    <h2 class="banking-title">
		<?php the_sub_field( 'rate_title' ); ?>
    </h2>
    <!--    <h3 class="rate-subtitle">-->
        ...
        <div class="banking-methods-list">
			<?php while ( have_rows( 'banking_method_group' ) ) : the_row(); ?>
                <div class="banking-methods-item">
                    ...
                    <!--                                    <img src="-->
					<?php //echo esc_url( $no_deposit_image['url'] ); ?><!--"-->
                    <!--                                         alt="-->
					<?php //echo esc_attr( $no_deposit_image['alt'] ); ?><!--"/>-->
                    <!--								--><?php //endif; ?>
                    <!--							--><?php //endwhile; ?>
                    <!--						--><?php //endif; ?>
                    <!--                    </div>-->
