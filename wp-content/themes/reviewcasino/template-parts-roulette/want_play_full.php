<section class="want-play want-play-full full-content">
		...
		<?php foreach ( $game as $game_post ) : ?>
            ...
            <article class="dark-decor-section other-review-item">
                <div class="logo-review-block">
					<?php
					echo get_the_post_thumbnail( $game_post->ID );
					?>
                ...
                <div class="middle-block">
                    ...
                    <div class="payouts-block">
						<?php if ( have_rows( 'information_review', $game_post->ID ) ) : ?>
							<?php while ( have_rows( 'information_review', $game_post->ID ) ) : the_row(); ?>
								<?php if ( have_rows( 'info_group', $game_post->ID ) ) : ?>
									<?php while ( have_rows( 'info_group', $game_post->ID ) ) : the_row(); ?>
										<?php if ( have_rows( 'info_table', $game_post->ID ) ) : ?>
											<?php while ( have_rows( 'info_table', $game_post->ID ) ) : the_row(); ?>
