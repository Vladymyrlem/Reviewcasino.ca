...
(function($) {
  $(document).ready(function() {
    ...
    $("#acftc-meta-box .inside").prepend(
      '<a href="#" class="acftc-copy-all acf-js-tooltip" title="Copy all to clipboard"></a>'
    );
    ...
    $("div.field").each(function(index) {
      ...
      if (
        ...
        $(this)
          ...
          .first()
          .append(
            '<span>| <a class="acftc-scroll__link" href="#acftc-' +
              field_key +
              '">Code</a></span>'
          );
      }
    ...
    var fieldsV5 = $("#acf-field-group-fields .acf-field-object")
      ...
      .filter(function() {
        return (
          $(this).parentsUntil("#acf-field-group-fields", ".acf-field-object")
            .length === 0
        );
      });
    ...
    fieldsV5.each(function(index) {
      ...
      if (data_type != "tab" && data_type != "message") {
        $(this)
          ...
          .eq(0)
          .append(
            '<a class="acftc-scroll__link" href="#acftc-' +
              field_key +
              '">Code</a>'
          );
      }
  ...
  var copyAllFields = new Clipboard(".acftc-copy-all", {
    text: function(trigger) {
      var $allCodeBlocks = $(
        "#acftc-meta-box .location-wrap--active .acftc-field-code pre"
      );
