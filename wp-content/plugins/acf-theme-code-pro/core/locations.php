...
class ACFTC_Locations {
	...
	private function get_location_select_html() {
        ...
        <div class="inside acf-fields -left acf-locations">
            <div class="acf-field acf-field-select" data-name="style" data-type="select">
                ...
                <div class="acf-input">
                    <select id="acftc-group-option" class="" data-ui="0" data-ajax="0" data-multiple="0"
	...
	private function get_locations_upgrade_notice_html( $location_rule ) {
        ...
        <div class="acftc-field-meta">
            <span class="acftc-field-meta__title"
                  data-pseudo-content="<?php echo $this->get_location_clean_text( $location_rule ); ?>"></span>
        </div>
	...
	protected function get_after_field_group_notice_html() {
        ...
        <div class="acftc-pro-notice">
            <a class="acftc-pro-notice__link"
               href="https://hookturn.io/downloads/acf-theme-code-pro/?utm_source=acftcfree" target="_blank">Upgrade to
                <strong>ACF Theme Code Pro</strong>.</a>
        </div>
