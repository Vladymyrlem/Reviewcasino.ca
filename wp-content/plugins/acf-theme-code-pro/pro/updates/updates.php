        ...
        <table class="form-table">
			...
			<?php if ( $status != 'valid' ) { ?>
                ...
                <tr valign="top">
                    ...
                    <td>
                        <input id="hookturn_acftcp_license_key" name="hookturn_acftcp_license_key" type="text"
                               class="regular-text" value="<?php esc_attr_e( $license ); ?>"/>
                        <label class="description"
                               for="hookturn_acftcp_license_key"><?php _e( 'Enter your license key' ); ?></label>
                    </td>
                </tr>
			<?php } ?>
...
function hookturn_acftcp_activate_license() {
	...
	if ( isset( $_POST['edd_license_activate'] ) ) {
		...
		// Call the custom API.
		$response = wp_remote_post( HOOKTURN_STORE_URL, array( 'timeout'   => 15,
		                                                       'sslverify' => false,
		                                                       'body'      => $api_params
		) );
