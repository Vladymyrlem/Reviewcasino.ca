        ...
        <div class="acftc-tool-inputs">
            ...
            <div class="acftc-field acftc-field--top">
                ...
                <div class="acftc-input">
                    <select id="acftc-registration-option" class="" data-ui="0" data-ajax="0" data-multiple="0"
            ...
            <div id="acftc-register-block" class="registration-wrap registration-wrap--active">
                ...
                <div class="acftc-tool-inputs">
                    ...
                    <div class="acf-block-code-hidden">add_action( 'acf/init', 'register_<span
                                class="acf-tc-block-name--lower-underscores">example</span>_block' );
                        ...
                        // 'enqueue_style' => get_template_directory_uri() . '/template-parts/blocks/<span
                                class="acf-tc-block-name--lower-dashes">example</span>/<span
                                class="acf-tc-block-name--lower-dashes">example</span>.css',
                        // 'enqueue_script' => get_template_directory_uri() . '/template-parts/blocks/<span
                                class="acf-tc-block-name--lower-dashes">example</span>/<span
                                class="acf-tc-block-name--lower-dashes">example</span>.js',
                    ...
                    <div class="acftc-field-meta">
                        <span class="acftc-field-meta__title" data-type="link"
                              data-pseudo-content="Register a Gutenberg Block"></span>
                    </div>
            ...
            <div id="acftc-register-options" class="registration-wrap">
                ...
                <div class="acftc-tool-inputs">
                    ...
                    <div class="acftc-field-meta">
                        <span class="acftc-field-meta__title" data-type="link"
                              data-pseudo-content="Register an Options Page"></span>
                    </div>
