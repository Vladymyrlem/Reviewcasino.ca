...
(function(blocks, components, i18n, element) {
  ...
  const iconBCN = el(
    ...
    el("path", {
      d:
        "M0.6 7.2C0.4 7.2 0.4 7.2 0.4 7.4V16.9C0.4 17.1 0.4 17.1 0.6 17.1H10.9C11.1 17.1 11.1 17.1 11.3 16.9L16 12.1 11.3 7.4C11.1 7.2 11.1 7.2 10.9 7.2ZM15 7.2 19.9 12.1 15 17.1H18.7C18.9 17.1 18.9 17.1 19.1 16.9L23.8 12.1 19.1 7.4C18.9 7.2 18.9 7.2 18.7 7.2Z"
    })
  );
    ...
    breadcrumbTrail.itemListElement.forEach(function(listElement, index) {
      ...
      if (index < length - 1 || bcnOpts.bcurrent_item_linked) {
        trailString.push(
          el(
            "a",
            { href: listElement.item["@id"] },
            decodeEntities(listElement.item.name)
          )
        );
      } else {
