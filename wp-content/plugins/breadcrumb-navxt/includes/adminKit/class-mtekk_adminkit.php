...
abstract class adminKit {
	...
	function add_page() {
		...
		$hookname = add_submenu_page( 'options-general.php', $this->full_name, $this->short_name, $this->access_level, $this->identifier, array(
			$this,
			'admin_page'
		) );
	...
	function opts_update() {
		...
		$new_settings = apply_filters( $this->unique_prefix . '_opts_update_to_save', array_udiff_assoc( $this->settings, $default_settings, array(
			$this,
			'setting_equal_check'
		) ) );
