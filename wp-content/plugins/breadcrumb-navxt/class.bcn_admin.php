	...
	function admin_page() {
        ...
        <div class="wrap"><h1><?php echo $this->full_name; ?></h1>
            ...
            <form action="<?php echo $this->admin_url(); ?>" method="post" id="bcn_admin-options">
                ...
                <div id="hasadmintabs">
                    <fieldset id="general" class="bcn_options">
                        <legend class="screen-reader-text"
                                data-title="<?php _e( 'A collection of settings most likely to be modified are located under this tab.', 'breadcrumb-navxt' ); ?>"><?php _e( 'General', 'breadcrumb-navxt' ); ?></legend>
                    ...
                    <fieldset id="post" class="bcn_options">
                        <legend class="screen-reader-text"
                                data-title="<?php _e( 'The settings for all post types (Posts, Pages, and Custom Post Types) are located under this tab.', 'breadcrumb-navxt' ); ?>"><?php _e( 'Post Types', 'breadcrumb-navxt' ); ?></legend>
						<?php
                            ...
                            <table class="form-table adminkit-enset-top">
								...
								if ( ! in_array( $post_type->name, array( 'page', 'post' ) ) ) {
                                    ...
                                    <tr valign="top">
                                        ...
                                        <td>
											<?php wp_dropdown_pages( array( 'name'              => $this->unique_prefix . '_options[apost_' . $post_type->name . '_root]',
											                                'id'                => $optid,
											                                'echo'              => 1,
                    ...
                    <fieldset id="tax" class="bcn_options alttab">
                        <legend class="screen-reader-text"
                                data-title="<?php _e( 'The settings for all taxonomies (including Categories, Tags, and custom taxonomies) are located under this tab.', 'breadcrumb-navxt' ); ?>"><?php _e( 'Taxonomies', 'breadcrumb-navxt' ); ?></legend>
                    ...
                    <fieldset id="miscellaneous" class="bcn_options">
                        <legend class="screen-reader-text"
                                data-title="<?php _e( 'The settings for author and date archives, searches, and 404 pages are located under this tab.', 'breadcrumb-navxt' ); ?>"><?php _e( 'Miscellaneous', 'breadcrumb-navxt' ); ?></legend>
                        ...
                        <table class="form-table">
                            ...
                            <tr valign="top">
                                ...
                                <td>
									<?php wp_dropdown_pages( array( 'name'              => $this->unique_prefix . '_options[aauthor_root]',
									                                'id'                => $optid,
									                                'echo'              => 1,
									                                'show_option_none'  => __( '&mdash; Select &mdash;' ),
									                                'option_none_value' => '0',
                        ...
                        <table class="form-table">
                            <tr valign="top">
                                ...
                                <td>
                                    <label>
                                        <input name="bcn_options[blimit_title]" type="checkbox" id="blimit_title"
                                               value="true" <?php checked( true, $this->settings['blimit_title']->get_value() ); ?> />
                                    ...
                                    <ul>
                                        <li>
                                            <label for="amax_title_length">
                                                ...
                                                <input type="number" name="bcn_options[amax_title_length]"
                                                       id="amax_title_length" min="1" step="1"
                                                       value="<?php echo esc_html( $this->settings['amax_title_length']->get_value(), ENT_COMPAT, 'UTF-8' ); ?>"
                                                       class="small-text"/>
                                            </label>
                                        </li>
                                    </ul>
                ...
                <p class="submit"><input type="submit" class="button-primary" name="bcn_admin_options"
