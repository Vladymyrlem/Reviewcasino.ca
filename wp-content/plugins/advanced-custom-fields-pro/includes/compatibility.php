...
if ( ! class_exists( 'ACF_Compatibility' ) ) :
	...
	class ACF_Compatibility {
		...
		function __construct() {
			...
			add_filter( 'acf/validate_field/type=date_time_picker', array(
				$this,
			...
			// location
			add_filter( 'acf/location/validate_rule/type=post_taxonomy', array(
				$this,
				'validate_post_taxonomy_location_rule'
			), 20, 1 );
			add_filter( 'acf/location/validate_rule/type=post_category', array(
				$this,
				'validate_post_taxonomy_location_rule'
			), 20, 1 );
