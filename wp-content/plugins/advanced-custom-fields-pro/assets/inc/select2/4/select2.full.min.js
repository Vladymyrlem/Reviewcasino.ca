!(function(n) {
  ...
  var e,
    ...
    a =
            ...
            for (var t in e) {
              ...
              if (1 !== n.length) {
                for (var o = 0; o < n.length; o++) {
                  var r = n[o];
                  (r = r.substring(0, 1).toLowerCase() + r.substring(1)) in i ||
                    (i[r] = {}),
      ...
      u.define("select2/dropdown/search", ["jquery", "../utils"], function(
        r,
        e
      ) {
        function t() {}
      ...
      u.define("select2/compat/containerCss", ["jquery", "./utils"], function(
        r,
        s
      ) {
        function a(e) {
      ...
      u.define("select2/compat/dropdownCss", ["jquery", "./utils"], function(
        r,
        s
      ) {
        function a(e) {
      ...
      u.define("select2/compat/inputData", ["jquery", "../utils"], function(
        r,
        n
      ) {
        function e(e, t, n) {
