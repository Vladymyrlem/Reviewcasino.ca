      ...
      482: function() {
        !(function(t) {
          var e = acf.Field.extend({
              ...
              return (
                a.find("[data-layout]").each(function() {
                  ...
                  if (n && s >= n) e.addClass("disabled");
                    ...
                    (l = (l = (l = (l = l.replace("{required}", r)).replace(
                      "{label}",
                      o
                    )).replace("{identifier}", c)).replace("{min}", a)),
                      e.append(
                        '<span class="badge" title="' + l + '">' + r + "</span>"
                      );
                  }
                }),
                a.outerHTML()
            ...
            add: function(t) {
              if (
                ((t = acf.parseArgs(t, { layout: "", before: !1 })),
                !this.allowAdd())
              )
                return !1;
              var e = acf.duplicate({
                    ...
                    if (t) {
                      ...
                      e.html(t),
                        ...
                        e
                          ...
                          .append(
                            e.find("> .compat-attachment-fields > tbody > tr")
                          ),
