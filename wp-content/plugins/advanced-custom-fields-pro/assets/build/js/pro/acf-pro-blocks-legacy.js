      ...
      /***/ function(
        ...
        (function($, undefined) {
          ...
          function fetchBlock(args) {
            const { attributes = {}, query = {}, delay = 0 } = args; // Use storage or default data.
          ...
          class BlockForm extends DynamicHTML {
            ...
            fetch() {
              // Extract props.
              const { attributes } = this.props; // Try preloaded data first.
            ...
            fetch() {
              let args =
                arguments.length > 0 && arguments[0] !== undefined
                  ? arguments[0]
                  : {};
              const { attributes = this.props.attributes, delay = 0 } = args; // Remember attributes used to fetch HTML.
...
*/
  ...
  \***********************************************************************************/
    ...
    /* harmony import */
    var _acf_blocks_legacy_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! ./_acf-blocks-legacy.js */ "./src/advanced-custom-fields-pro/assets/src/js/pro/_acf-blocks-legacy.js"
    );
  })();
  /******/
})();
