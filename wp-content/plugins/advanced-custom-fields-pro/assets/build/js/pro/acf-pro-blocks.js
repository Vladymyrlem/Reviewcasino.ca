...
(function() {
  ...
  \*************************************************************************/
      /***/ function(
        ...
        /* harmony import */
        var _wordpress_element__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
        ...
        (($, undefined) => {
          ...
          function registerBlockType(blockType) {
            ...
            const result = wp.blocks.registerBlockType(
              blockType.name,
              blockType
          ...
          function getBlocks(args) {
            ...
            select("core/block-editor")
              .getBlocks()
              .forEach(recurseBlocks); // Loop over args and filter.

            for (const k in args) {
              blocks = blocks.filter(_ref4 => {
                let { attributes } = _ref4;
          ...
          function fetchBlock(args) {
            ...
            const queueId = md5(
              JSON.stringify(
                _objectSpread(
                  _objectSpread(_objectSpread({}, attributes), context),
                  query
                )
              )
            );
            ...
            BlockListBlock =>
              class WrappedBlockEdit extends Component {
                constructor(props) {
                  ...
                  const { name, attributes } = this.props; // Only run on ACF Blocks.
          ...
          const BlockBody = withSelect((select, ownProps) => {
            const { clientId } = ownProps; // Use optional rootClientId to allow discoverability of child blocks.
          ...
          class BlockForm extends DynamicHTML {
            setup(_ref8) {
              let { attributes } = _ref8;
              this.id = `BlockForm-${attributes.id}`;
            }

            fetch() {
              // Extract props.
              const { attributes, context } = this.props; // Try preloaded data first.
            ...
            componentDidAppend() {
              ...
              const { $el } = this.state; // Callback for updating block data.
          ...
          class BlockPreview extends DynamicHTML {
            ...
            componentDidAppend() {
              ...
              const { $el } = this.state; // Generate action friendly type.
          ...
          const BlockAlignmentMatrixToolbar =
            ...
            wp.blockEditor.BlockAlignmentMatrixToolbar; // Gutenberg v10.x begins transition from Toolbar components to Control components.
          ...
          function withAlignContentComponent(OriginalBlockEdit, blockType) {
            ...
            blockType.align_content = validateAlignment(
              blockType.align_content
      ...
      /***/ function(module, __unused_webpack_exports, __webpack_require__) {
        (function() {
          var crypt = __webpack_require__(
              /*! crypt */ "./node_modules/crypt/crypt.js"
            ),
...
*/
  ...
  \****************************************************************************/
    __webpack_require__.r(__webpack_exports__);
    /* harmony import */
    var _acf_jsx_names_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
      /*! ./_acf-jsx-names.js */ "./src/advanced-custom-fields-pro/assets/src/js/pro/_acf-jsx-names.js"
    );
    /* harmony import */
    var _acf_jsx_names_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/ __webpack_require__.n(
      _acf_jsx_names_js__WEBPACK_IMPORTED_MODULE_0__
    );
    /* harmony import */
    var _acf_blocks_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! ./_acf-blocks.js */ "./src/advanced-custom-fields-pro/assets/src/js/pro/_acf-blocks.js"
    );
  })();
  /******/
})();
