			...
			<?php if ( $is_defined_license ) { ?>
				...
				<?php if ( ! $active ) { ?>
                    ...
                    <form action="" method="post">
                        ...
                        <input type="submit" value="<?php echo esc_attr( __( 'Retry Activation', 'acf' ) ); ?>"
                ...
                <tr>
                    ...
                    <td>
						<?php if ( $update_available ) : ?>
							...
							<?php if ( $license_error ) : ?>
                                <a class="button" disabled="disabled"
                                   href="#"><?php _e( 'Please reactivate your license to unlock updates', 'acf' ); ?></a>
							<?php elseif ( $active ) : ?>
                                <a class="button button-primary"
                                   href="<?php echo esc_attr( admin_url( 'plugins.php?s=Advanced+Custom+Fields+Pro' ) ); ?>"><?php _e( 'Update Plugin', 'acf' ); ?></a>
							<?php else : ?>
                                <a class="button" disabled="disabled"
						...
						<?php else : ?>
                            ...
                            <a class="button"
                               href="<?php echo esc_attr( add_query_arg( 'force-check', 1 ) ); ?>"><?php _e( 'Check Again', 'acf' ); ?></a>
						<?php endif; ?>
                    </td>
                </tr>
				<?php if ( $changelog ) : ?>
