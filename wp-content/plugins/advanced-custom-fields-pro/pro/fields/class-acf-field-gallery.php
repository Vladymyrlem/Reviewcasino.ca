		...
		*/
		...
		function render_attachment( $id, $field ) {
            ...
            <div class="acf-gallery-side-info">
                ...
                <p class="actions">
                    <a href="#" class="acf-gallery-edit"
                       data-id="<?php echo esc_attr( $id ); ?>"><?php _e( 'Edit', 'acf' ); ?></a>
                    <a href="#" class="acf-gallery-remove"
                       data-id="<?php echo esc_attr( $id ); ?>"><?php _e( 'Remove', 'acf' ); ?></a>
                </p>
            </div>
                    ...
                    <div class="acf-gallery-attachments">
						<?php if ( $attachments ) : ?>
							...
							foreach ( $attachments as $i => $attachment ) :
								...
								?>
                                <div class="<?php echo esc_attr( $a_class ); ?>"
                                     data-id="<?php echo esc_attr( $a_id ); ?>">
                    ...
                    <div class="acf-gallery-side-inner">
                        ...
                        <div class="acf-gallery-toolbar">
                            <ul class="acf-hl">
                                <li>
                                    <a href="#"
                                       class="acf-button button acf-gallery-close"><?php _e( 'Close', 'acf' ); ?></a>
                                </li>
                                <li class="acf-fr">
                                    <a class="acf-button button button-primary acf-gallery-update"
                                       href="#"><?php _e( 'Update', 'acf' ); ?></a>
                                </li>
                            </ul>
                        </div>
                    </div>
