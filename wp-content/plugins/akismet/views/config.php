            ...
            <div class="akismet-card">
                ...
                <div class="akismet-new-snapshot">
                    <iframe allowtransparency="true" scrolling="no" frameborder="0"
                            ...
                            src="<?php echo esc_url( sprintf( 'https://tools.akismet.com/1.0/snapshot.php?blog=%s&api_key=%s&height=200&locale=%s', urlencode( get_option( 'home' ) ), Akismet::get_api_key(), get_locale() ) ); ?>"></iframe>
                    <ul>
                        <li>
